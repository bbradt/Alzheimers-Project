...
Not actual normalization, but appleis log transformation within experiments.
```{r}
...
Obsolete Loess normalization function for datasets between microarrays.
```{r}
...
writes normalized data based on a sampleset.
...
loads normalized files from directory and writes them to files.
```{r}
